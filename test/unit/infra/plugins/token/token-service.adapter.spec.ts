...
describe('Service: TokenServiceAdapter', () => {
    ...
    beforeEach(async () => {
        sutTokenServiceAdapter = new TokenServiceAdapter({ get: jest.fn().mockReturnValue({
            secret: 'any_secret', 
    ...
    describe('sign', () => {
        ...
        it('should throws if jsonwebtoken.sign throws', async () => {
            ...
            expect(() => sutTokenServiceAdapter.sign({ key: 'value'})).toThrowError('JWT ERROR');
        });
    ...
    describe('verify', () => {
        it('should call jsonwebtoken.verify with correct values', async () => {
            ...
            expect(jsonwebtoken.verify).toBeCalledWith('any_token', 'any_secret');
        ...
        it('should return null if jsonwebtoken.verify throws', async () => {
            ...
            expect(() => sutTokenServiceAdapter.verify('any_token')).toThrowError('JWT ERROR');
        });
