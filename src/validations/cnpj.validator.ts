...
export class IsCnpjValidationConstraint implements ValidatorConstraintInterface {
  ...
  defaultMessage(args: ValidationArguments) {
    return `${args.property} must contain valid CNPJ!`;
  }
}
...
export function IsCnpj(validationOptions?: ValidationOptions) {
  return function (object: Object, propertyName: string) {
    registerDecorator({
      ...
      validator: IsCnpjValidationConstraint,
    });
  };
}
